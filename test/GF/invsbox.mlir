...
module {
  ...
  func.func @inv_subbytes_kernel(%state: memref<16xi8>) {
    ...
    %s0  = gf.inv_sbox %b0  : i8
    %s1  = gf.inv_sbox %b1  : i8
    %s2  = gf.inv_sbox %b2  : i8
    %s3  = gf.inv_sbox %b3  : i8
    %s4  = gf.inv_sbox %b4  : i8
    %s5  = gf.inv_sbox %b5  : i8
    %s6  = gf.inv_sbox %b6  : i8
    %s7  = gf.inv_sbox %b7  : i8
    %s8  = gf.inv_sbox %b8  : i8
    %s9  = gf.inv_sbox %b9  : i8
    %s10 = gf.inv_sbox %b10 : i8
    %s11 = gf.inv_sbox %b11 : i8
    %s12 = gf.inv_sbox %b12 : i8
    %s13 = gf.inv_sbox %b13 : i8
    %s14 = gf.inv_sbox %b14 : i8
    %s15 = gf.inv_sbox %b15 : i8
  ...
  func.func @bench_inv_subbytes(%iters: index, %state: memref<16xi8>) -> i8 {
    ...
    %acc = scf.for %t = %c0 to %iters step %c1 iter_args(%a = %acc0) -> i8 {
      func.call @inv_subbytes_kernel(%state) : (memref<16xi8>) -> ()
  ...
  func.func @main() -> i8 {
    ...
    %acc = func.call @bench_inv_subbytes(%iters, %state)

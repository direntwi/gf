//===- gf-cap-demo.c - Simple demo of C-API -----------------------===//
//
...
// RUN: gf-capi-test 2>&1 | FileCheck %s
...
int main(int argc, char **argv) {
  ...
  // This adds dozens of MB of binary size over just the gf dialect.
  registerAllUpstreamDialects(ctx);
  mlirDialectHandleRegisterDialect(mlirGetDialectHandle__gf__(), ctx);
